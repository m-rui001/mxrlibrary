...
#let ori(
  ...
  let bg-color = if theme == "dark" { rgb("#1E1E1E") } else { rgb("#f5f5f5") }
  ...
  if maketitle {
    ...
    align(center + top)[
      ...
      #v(2em, weak: true)
      #text(3em, weight: 400, title, font: "FZShuti",)
      #v(3em, weak: true)
      #text(2em, weight: 400, author, font: "FZShuti",)
    ]
    pagebreak(weak: true)
  }
